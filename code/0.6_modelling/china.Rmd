...
model_thi <- runMLwiN(mobility_diff_pct ~  
                    ...
                    data = thi_mob_vars, ,estoptions = list(sort.ignore=TRUE, resi.store=TRUE, maxiter = 40)  )
...
write.csv(x, file='/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/regression/THI_united_states_params_4SD.csv')
```
