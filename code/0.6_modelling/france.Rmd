...
mob_vars <- st_read("/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/paper2/france/thi_mobility_heat_w_vars_90_4SD.csv")
...
# Model 2: All except transit (least present in data set)
# DOES NOT CONVERGE

model_2 <- runMLwiN(c(residential_difference, workplaces_difference, grocery_pharmacy_difference, retail_difference, parks_difference) ~  
                       1 +
                       thi_centered + temp_diff + 
                       heatwave_dur + stage_frac + weekend +
...
# Model 3: All except grocery_pharmacy
# CONVERGES

model_2 <- runMLwiN(c(residential_difference, workplaces_difference, transit_difference, retail_difference, parks_difference) ~  
                       1 +
                       thi_centered + temp_diff + 
                       heatwave_dur + stage_frac + weekend +
...
model_4 <- runMLwiN(c(residential_difference, workplaces_difference, transit_difference, retail_difference, parks_difference) ~  
                       1 +
                       thi_centered + temp_diff + 
                       heatwave_dur + stage_frac + weekend +
                       popden_dec + 
...
```{r}
# Model 5: Add HDI and Age
# DOES NOT CONVERGE

model_5 <- runMLwiN(c(residential_difference, workplaces_difference, transit_difference, retail_difference, parks_difference) ~  
                       1 +
...
```{r}
# Model 6: Add physical variables
# CONVERGES
...
```{r}
# Model 6: re-introduce grocery/pharmacy
# CONVERGES

model_5 <- runMLwiN(c(residential_difference, workplaces_difference, transit_difference, grocery_pharmacy_difference, retail_difference, parks_difference) ~  
                       1 +
                       heat_temp_centered + temp_diff + 
                       early_hw + heatwave_dur + stage_frac + weekend +
                       popden_dec + HDI_dec + over60_dec + 
...
write.csv(x, file='/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/regression/params_final_3SD_v4.csv')
```
