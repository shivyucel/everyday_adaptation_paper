...
```{r}
model_6 <- runMLwiN(c(residential_difference, workplaces_difference, grocery_pharmacy_difference, retail_difference, parks_difference) ~  
                       1 +
...
write.csv(x, file='/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/regression/thi_france_params_4SD_precip_sort_v1.csv')
```
