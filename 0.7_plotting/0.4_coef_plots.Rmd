...
regression <- st_read('/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/paper2/results/plotting/china_coefs.csv')
...
mob_vars <- st_read("/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/paper2/results/plotting/temporal_coefs_v2.csv")
#mob_vars <- mob_vars %>% 
...
mob_vars <- st_read("/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/paper2/results/plotting/context_coefs_v2.csv")
#mob_vars <- mob_vars %>% 
#  mutate(response = fct_reorder(variable, variable, min)) %>%   arrange(response)
